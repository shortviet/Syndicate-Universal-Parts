...
if PlayersBanned[LocalPlayer.Name] or PlayersBanned[LocalPlayer.UserId] then
game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "Banned",
        Text = "You got banned to use SP Hub",
        Duration = 10,
        Icon = "rbxassetid://5108797866"
    })
    OrionLib:Destroy()
    return
end
...
local AdminsPlayer = {
  ["nadermohamedtest"] = true
}

if AdminsPlayer[LocalPlayer.Name] or AdminsPlayer[LocalPlayer.UserId] then
game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "Admin",
        Text = "You are admin",
        Duration = 6
...
local OrionLib = {
    ...
    Themes = {
        Default = {
            ...
            Stroke = Color3.fromRGB(13, 13, 13),
...
CreateElement(
    ...
    function(Bottom, Left, Right, Top)
        local Padding =
            ...
            "UIPadding",
            {
                PaddingBottom = UDim.new(0, Bottom or 5),
                PaddingLeft = UDim.new(0, Left or 5),
                PaddingRight = UDim.new(0, Right or 5),
                PaddingTop = UDim.new(0, Top or 5)
            }
        )
        return Padding
    end
    ...
    if NotificationConfig.IsPC and isPC then
        return nil
            ...
            local NotificationFrame =
                SetChildren(
                SetProps(
                    MakeElement("RoundFrame", Color3.fromRGB(16, 16, 16), 0, 10),
                    {
                ...
                {
                    MakeElement("Stroke", Color3.fromRGB(193, 61, 66), 1.2),
...
local MainWindow =
        ...
        SetChildren(
            SetProps(
                ...
                {
                    Parent = Orion,
                    Position = isMobile and UDim2.new(0.5, -234, 0.5, -172) or UDim2.new(0.5, -299, 0.5, -172),
...
T.Image = "rbxassetid://83114982417764"
...
local function ToggleUI()
    ...
    if UIHidden then
        TweenService:Create(
            ...
            {
                Position = MainWindow.Position + UDim2.new(0, 0, 0.1, 0),
            }
        ):Play()
...
local hoverSize = UDim2.new(0, sizeValue + 10, 0, sizeValue + 10)
...
T.MouseEnter:Connect(function()
    ...
    TweenService:Create(T, tweenInfo, {Size = hoverSize, Position = hoverPosition}):Play()
end)

T.MouseLeave:Connect(function()
    local normalPosition = getCenteredPosition(hoverSize, normalSize, T.Position)
    TweenService:Create(T, tweenInfo, {Size = normalSize, Position = normalPosition}):Play()
end)

T.MouseButton1Click:Connect(function()
    local growTween = TweenService:Create(T, tweenInfo, {Size = hoverSize})
    growTween:Play()
...
if TabConfig.IsMobile and isMobile then
    ...
    if not TabFrame:FindFirstChild("SelectedBar") then
        local Bar = Instance.new("Frame")
        Bar.Name = "SelectedBar"
        Bar.Parent = TabFrame
        Bar.BackgroundColor3 = Color3.fromRGB(0, 162, 255)
        Bar.BorderSizePixel = 0
        Bar.Size = UDim2.new(0, 0, 0, 3)
        Bar.Position = UDim2.new(0.5, -69, 1, 1.7)
        
        local Corner33 = Instance.new("UICorner")
        Corner33.CornerRadius = UDim.new(0, 8)
        Corner33.Parent = Bar
        TweenService:Create(
            Bar,
            TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
            {Size = UDim2.new(0, 137, 0, 3)}
        ):Play()
    end
end
...
AddConnection(
    ...
    function()
        for _, Tab in next, TabHolder:GetChildren() do
            if Tab:IsA("TextButton") then
                ...
                if Tab:FindFirstChild("SelectedBar") then
                    TweenService:Create(
                        Tab.SelectedBar,
                        TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
        ...
        if not TabFrame:FindFirstChild("SelectedBar") then
            ...
            Bar.Size = UDim2.new(0, 0, 0, 3)
            Bar.Position = UDim2.new(0.5, -69, 1, 1.7)
            local Corner123 = Instance.new("UICorner")
            Corner123.CornerRadius = UDim.new(0, 8)
            Corner123.Parent = Bar
        end

        TweenService:Create(
            TabFrame.SelectedBar,
            TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
            {Size = UDim2.new(0, 137, 0, 3)}
        ):Play()
    end
        ...
        local function GetElements(ItemParent)
            ...
            function ElementFunction:AddParagraph(Text, Content)
                ...
                local ParagraphFrame =
                    ...
                    SetChildren(
                        SetProps(
                            MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 2, 5),
                            {
                                Size = UDim2.new(1, 0, 0, 30),
    ...
    ButtonConfig.Icon = ButtonConfig.Icon or "rbxassetid://87129552111975"
...
local Corner = Instance.new("UICorner", ShineBar)
...
local ButtonFrame =
    AddThemeObject(
        SetChildren(
            SetProps(
                MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 1, 12),
                {
        ...
        TweenService:Create(
            ...
            TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
            {
                BackgroundColor3 = Color3.fromRGB(
                    OrionLib.Themes[OrionLib.SelectedTheme].Second.R * 255 + 5,
                    OrionLib.Themes[OrionLib.SelectedTheme].Second.G * 255 + 5,
                    OrionLib.Themes[OrionLib.SelectedTheme].Second.B * 255 + 5
                )
            }
        ):Play()
    end
...
AddConnection(
    ...
    function()
        ...
        ShineBar.Size = UDim2.new(0, 0, 1, 0)
        ShineBar.Position = UDim2.new(0, 0, 0, 0)
        ShineBar.BackgroundTransparency = 0.6
    ...
    if ToggleConfig.IsPC and isPC then
        return nil
                ...
                local ToggleBox =
                    SetChildren(
                    SetProps(
                        MakeElement("RoundFrame", ToggleConfig.Color, 1, 4),
                        {
            ...
            function ElementFunction:AddSlider(SliderConfig)
                ...
                SliderConfig.Color = SliderConfig.Color or Color3.fromRGB(3, 39, 17)
    ...
    if SliderConfig.IsPC and isPC then
        return nil
                ...
                local SliderDrag =
                    SetChildren(
                    SetProps(
                        MakeElement("RoundFrame", SliderConfig.Color, 1, 5),
                        {
                            Size = UDim2.new(0, 0, 1, 0),
                            BackgroundTransparency = 0.5,
                            ClipsDescendants = true
                ...
                local SliderFrame =
                    ...
                    SetChildren(
                        SetProps(
                            MakeElement("RoundFrame", Color3.fromRGB(0, 0, 0), 2, 4),
                            {
    ...
    if BindConfig.IsPC and isPC then
        return nil
                ...
                local BindBox =
                    ...
                    SetChildren(
                        SetProps(
                            MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 2, 4),
                            {
                                Size = UDim2.new(0, 24, 0, 24),
    ...
    if TextboxConfig.IsPC and isPC then
        return nil
                ...
                local TextContainer =
                    ...
                    SetChildren(
                        SetProps(
                            MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 1, 4),
                            {
                                Size = UDim2.new(0, 24, 0, 24),
                                Position = UDim2.new(1, -12, 0.5, 0),
                                AnchorPoint = Vector2.new(1, 0.5)
